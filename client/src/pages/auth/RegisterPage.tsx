            ...
            {systemStatus?.isInitialSetupOpen ? (
              ...
              <div className="p-3.5 rounded-xl bg-purple-950/40 border border-purple-500/30 flex items-start gap-2 text-xs text-purple-300">
                ...
                <div>
                  ...
                  {pendingInvite.targetRole && pendingInvite.targetRole !== 'INVITED_USER' && (
                    <span>Joining as <span className="font-bold text-white">{pendingInvite.targetRole === 'SUPER_OWNER' ? 'Super Owner' : 'Co-Owner'}</span></span>
                  )}
                </div>
              </div>
            ) : (
